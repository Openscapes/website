...
Openscapes opens the landscapes of science through community, data, and code. This means promoting open science: open data, open knowledge, and using the internet for good. It also means open culture: collaboration, empathy, and kindness. We aim to create a positive open culture in science, so we can do better science in less time.
...
The Openscapes website was created by Julia Lowndes — using the same open data science workflows she uses for research and promotes through Openscapes. The website is created with RStudio's [blogdown](https://bookdown.org/yihui/blogdown/), using the [hugo-universal-theme](https://themes.gohugo.io//theme/hugo-universal-theme/).
