...
[Quarto](https://quarto.org/) is an open-source scientific and technical publishing system built on Pandoc that allows users to create dynamic documents, presentations, websites, and more. What is especially unique about Quarto is that it works seamlessly across multiple languages \-- R, Python, Julia, and ObservableJS \-- allowing for easy collaboration among users from different backgrounds and areas of expertise. Conversation was centered around the experiences of NASA researchers from different [Distributed Active Archive Centers](https://nssdc.gsfc.nasa.gov/earth/daacs.html#:~:text=The%20Distributed%20Active%20Archive%20Centers,support%20to%20global%20change%20researchers.) (DAACs) using Quarto to enable collaborative, data-intensive, open science in the cloud. The recording is on [Openscapes YouTube](https://www.youtube.com/watch?v=azVAl343CIU).
