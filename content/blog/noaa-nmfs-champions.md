...
In between the Champions sessions, the cohort learned the in-and-outs of using RStudio, Git and GitHub for team and project management with clinics and 1-on-1 sessions. Each team also met separately to work on their on goals for improving the team workflow, using GitHub Issues and Pathways documents as a way to organize together.
...
<br>
<center>
  <img src="/img/blog/nwfsc-ao-proj-board2.png" width="500px">
  <figcaption> GitHub Project Board from the NWFSC Ocean Acidification Group, see other examples on the [NMFS-Openscapes Wiki](https://github.com/nmfs-openscapes/.github/wiki/11-GitHub-Project-Boards).</figcaption>
</center>
<br>
...
**[nmfs-openscapes](https://github.com/nmfs-openscapes)** **GitHub Organization** Eli Holmes (NWFSC) and Em Markowitz (AFSC) have spear-headed the [nmfs-openscapes](https://github.com/nmfs-openscapes) GitHub Organization to help coordinate and give visibility to all the open data science work at NMFS. We especially love the Wiki, a growing resource with examples of[ GitHub in gov](https://github.com/nmfs-openscapes/.github/wiki/02-GitHub-in-Government#github-in-noaa--nmfs) and[ project boards](https://github.com/Openscapes/2021-noaa-nmfs/wiki/2-Issues-and-Project-Boards#project-boards).

It was really a thoughtful and dedicated group, the following is a bit more about each team. Look out for further blogs about what the Openscapes team learned and what’s coming next.
